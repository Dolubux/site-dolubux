<template>
  <div class="flex flex-col m-auto pt-8 lg:pt-16 w-full big:w-8/12">
    <div class="">
      ...
      <div
        class="grid grid-cols-3 gap-16 w-10/12 m-auto md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 xl:gap-8 big:w-full"
        data-wow-offset="30"
      >
