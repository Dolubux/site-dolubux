import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-CTvqgu5W.mjs';
import { a as useRuntimeConfig, b as useNuxtApp } from './server.mjs';
import { z as hash } from '../runtime.mjs';
import { u as useContentPreview } from './preview-CiuIVal1.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-Cinw7KFi.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-TjJU1MPM.mjs.map
