...
import { c as asyncDataDefaults, b as useNuxtApp, d as createError, a as useRuntimeConfig } from './server.mjs';
import { A as withLeadingSlash, j as joinURL, y as withoutTrailingSlash, B as withBase, z as hash } from '../runtime.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-CiuIVal1.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Cinw7KFi.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CTvqgu5W.mjs.map
